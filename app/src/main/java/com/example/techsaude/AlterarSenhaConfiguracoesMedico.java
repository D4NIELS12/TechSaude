...
public class AlterarSenhaConfiguracoesMedico extends AppCompatActivity {
    EditText edtSenhaAtual, edtNovaSenha, edtConfirmarSenha;
    Button btnAlterarSenha;
    ImageView imgVoltarSenha;
    String URL = "http://tcc3edsmodetecgr3.hospedagemdesites.ws/alterar_senha_configuracoes_medico.php";  // coloque sua URL

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alterar_senha_configuracoes_medico);
    ...
    private void alterarSenha() {
        ...
        StringRequest request = new StringRequest(
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("idMedico", String.valueOf(idMedico)); // substitua pelo login real
